                ...
                container.Page(page =>
                {
                    ...
                    page.Content().Column(col =>
                    {
                        ...
                        col.Item().Table(tbl =>
                        {
                            ...
                            tbl.Cell().Row(2).Column(2).CellNoBoder(6).Text(string.Concat(students.Key.ProgramName, " ")).SetFontSize(lineHeight: 1.5f);
                            tbl.Cell().Row(2).Column(3).CellNoBoder(3).Text("المستوى").SetFontSize(lineHeight: 1.5f);
                            tbl.Cell().Row(2).Column(4).CellNoBoder(6).Text(students.Key.Level.ToString()).SetFontSize(lineHeight: 1.5f);
